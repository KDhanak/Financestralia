    ...
    return (
        <>
            ...
            <div className="bg-white">
                ...
                <div className="h-3/5 tablet:mx-[100px] laptop:mx-[200px] lLaptop:mx-[300px] monitor:mx-[600px] 4K:mx-[700px] bg-primary_4 text-primary_3 p-5 -mt-28 relative shadow-lg">
