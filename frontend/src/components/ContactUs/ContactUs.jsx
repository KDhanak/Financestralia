    ...
    return (
        <>
            <div className="contact-us-container items-center justify-center flex flex-col">
                ...
                <form className="contact-form flex flex-col" onSubmit={handleFormSubmit}>
                    ...
                    <div className="space-y-4 mt-4">
                            ...
                            <div className="form-group flex flex-col">
                                ...
                                <div className="flex space-x-4">
                                    <label className="flex items-center">
                                        <input type="radio" name="is_client" value="YES" checked={formData.is_client === "YES"} onChange={handleChange} required
                                        />
                                        <span className="ml-2">Yes</span>
                                    </label>
                                    <label className="flex items-center">
                                        <input type="radio" name="is_client" value="NO" checked={formData.is_client === "NO"} onChange={handleChange} required
                                        />
                        ...
                        <button type="submit" className="items-center justify-center border w-full border-black">Submit</button>
                        </div>
                </form>
            </div>
        </>
