...
const business = ["Accounting and Business Advisory", "Lending and Finance", "General Insurance", "Consulting",];
const individuals = ["Wealth Management", "SMSF Administration and Advisory", "Lending and Finance", "Risk Insurance", "Accounting and Business Advisory",];
    ...
    return (
        <>
            <div className="bg-primary_1 mt-10">
                <div className="flex flex-row justify-center space-x-28 py-10">
